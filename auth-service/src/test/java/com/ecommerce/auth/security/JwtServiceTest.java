...
class JwtServiceTest {
  ...
  private final String secret = "my-super-secret-key-for-jwt-authentication-123456789";
  ...
  void extractEmail_shouldReturnUserEmail() {
    ...
    assertEquals("rakshitha@example.com", email);
  }
  ...
  void extractUsername_shouldReturnUsername() {
    ...
    assertEquals("rakshitha", username);
  }
