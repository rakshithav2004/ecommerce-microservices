...
class AuthServiceImplTest {
    ...
    void register_shouldCreateUserSuccessfully() {
        ...
        when(userRepository.existsByEmail("rakshitha@example.com"))
                .thenReturn(false);
        ...
        verify(userRepository)
                .existsByEmail("rakshitha@example.com");
    ...
    void login_shouldReturnAuthResponse() {
        ...
        when(userRepository.findByEmail("rakshitha@example.com"))
        ...
        verify(userRepository)
                .findByEmail("rakshitha@example.com");
