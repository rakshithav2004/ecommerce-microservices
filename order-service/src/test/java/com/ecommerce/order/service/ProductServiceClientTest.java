...
class ProductServiceClientTest {
    ...
    void shouldGetProductById() {
        ...
        when(productClient.getProductById("product-123"))
                .thenReturn(response);

        ProductResponse result =
                productServiceClient.getProductById("product-123");
    ...
    void shouldThrowExceptionWhenGetProductByIdFallbackIsCalled() {
        ...
        IllegalStateException exception = assertThrows(
                ...
                () -> productServiceClient.getProductByIdFallback(
                        "product-123",
                        throwable
                )
        );
    ...
    void shouldReserveStock() {
        ...
        when(productClient.reserveStock("product-123", 5))
                .thenReturn(response);
    ...
    void shouldThrowExceptionWhenReserveStockFallbackIsCalled() {
        ...
        IllegalStateException exception = assertThrows(
                IllegalStateException.class,
                () -> productServiceClient.reserveStockFallback(
                        "product-123",
                        5,
                        throwable
                )
    ...
    void shouldReleaseStock() {
        ...
        when(productClient.releaseStock("product-123", 5))
                .thenReturn(response);
    ...
    void shouldThrowExceptionWhenReleaseStockFallbackIsCalled() {
        ...
        IllegalStateException exception = assertThrows(
                IllegalStateException.class,
                () -> productServiceClient.releaseStockFallback(
                        "product-123",
                        5,
                        throwable
                )
