...
class OrderRepositoryTest {
    ...
    void shouldReturnEmptyWhenOrderNumberDoesNotExist() {
        ...
        Optional<Order> result =
                orderRepository.findByOrderNumber("INVALID-ORDER");
    ...
    void shouldCheckIfOrderNumberExists() {
        ...
        boolean result =
                orderRepository.existsByOrderNumber("ORD-001");
    ...
    void shouldReturnFalseWhenOrderNumberDoesNotExist() {
        ...
        boolean result =
                orderRepository.existsByOrderNumber("INVALID-ORDER");
    ...
    void shouldCheckIfCustomerHasOrders() {
        ...
        boolean result =
                orderRepository.existsByCustomerId("CUSTOMER-001");
    ...
    void shouldReturnFalseWhenCustomerHasNoOrders() {
        ...
        boolean result =
                orderRepository.existsByCustomerId("CUSTOMER-999");
