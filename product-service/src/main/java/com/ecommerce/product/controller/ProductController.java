...
public class ProductController {
  ...
  @Operation(
      ...
      description =
          "Creates a new product with the provided details and validates the product request")
  @PostMapping
  ...
  @Operation(
      ...
      description =
          "Retrieves a paginated list of products with optional filtering by category, search keyword, price range, and stock availability")
  @GetMapping
  public Page<ProductResponse> getAllProducts(
      ...
      Pageable pageable) {
    return productService.getAllProducts(category, search, minPrice, maxPrice, inStock, pageable);
  }
  ...
  @Operation(
      ...
      description =
          "Reserves the specified quantity of stock for a product when processing an order")
