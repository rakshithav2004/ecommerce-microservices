...
class ProductRepositoryTest {
    ...
    void shouldFindProductBySku() {
        ...
        Optional<Product> result =
                productRepository.findBySku("PHONE-001");
    ...
    void shouldReturnEmptyWhenSkuDoesNotExist() {
        ...
        Optional<Product> result =
                productRepository.findBySku("INVALID-001");
    ...
    void shouldCheckIfSkuExists() {
        ...
        boolean result =
                productRepository.existsBySku("PHONE-001");
    ...
    void shouldReturnFalseWhenSkuDoesNotExist() {
        ...
        boolean result =
                productRepository.existsBySku("INVALID-001");
