...
class ProductServiceImplTest {
    ...
    void createProduct_shouldCreateSuccessfully() {
        ...
        when(productRepository.existsBySku("PHONE-001"))
                .thenReturn(false);
    ...
    void getProductById_shouldReturnProduct() {
        ...
        ProductResponse response =
                productService.getProductById("product-001");
    ...
    void updateProduct_shouldThrowExceptionWhenNewSkuAlreadyExists() {
        ...
        when(productRepository.existsBySku("PHONE-002"))
                .thenReturn(true);
    ...
    void getAllProducts_shouldReturnProducts() {
        ...
        assertEquals(
                "PHONE-001",
                result.getContent().get(0).sku()
        );

        verify(mongoTemplate)
                .count(any(), eq(Product.class));

        verify(mongoTemplate)
                .find(any(), eq(Product.class));
    }
